		jQuery(document.body).on('submit', '#buddyforms_form_kegiatan-ormas', function (event) {
		    var formIsInitialized = jQuery(this).data('initialize');
		    var formSlug = 'kegiatan-ormas';
            ...
            if(BuddyFormsHooks){
                ...
                BuddyFormsHooks.doAction('buddyforms:form:render', ["kegiatan-ormas", ["bootstrap","jQuery","focus"], "buddyforms_ajax_process_edit_post", "post", formTargetStatus]);
            } else {
